...
<form action="${pageContext.request.contextPath}/api/chap5/test" method="post">
	<img class="murach_logo" src="/WebProgramming/resources/images/murach_logo.jpg" alt="logo" width="100" />
	<h1>Survey</h1>
	<p>If you have a moment, we'd appreciate it if you would fill out this survey.</p>
	<h2>Your information:</h2>
	<label>First Name</label>
	<input type="text" name="ifirstname" required>
	<br>
	<label>Last Name</label>
	<input type="text" name="ilastname" required>
	<br>
	<label>Email</label>
